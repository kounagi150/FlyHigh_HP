...
<Image src="/group.jpeg" alt="Fly High!! 集合写真" fill className="object-cover" priority/>
<div className="absolute inset-0 bg-white/30"></div>
</div>
<div className="relative z-20 text-center max-w-4xl mx-auto px-4">
<div className="mb-8">
<Image src="/logo.png" alt="Fly High!! ロゴ" width={500} height={250} className="mx-auto filter drop-shadow-2xl" priority/>
</div>
<div className="space-y-4 mb-8">
<p className="text-lg md:text-xl text-gray-700 font-medium">
次回開催日: <span className="text-orange-600 font-semibold">2025年11月予定</span>
</p>
