  ...
  return (
    <section id="gallery" className="py-32 bg-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {galleryItems.map((item, index) => (
            <MotionWrapper
              ...
              delay={index * 0.1}
              direction="up"
              className={`group relative overflow-hidden rounded-2xl bg-gray-800 shadow-2xl hover:shadow-orange-500/20 transition-all duration-500 transform hover:-translate-y-2 ${index === 0 || index === 3 ? 'md:col-span-1 lg:col-span-2' : ''
                }`}
            >
        ...
        <MotionWrapper direction="up" delay={0.4} className="text-center mt-16">
